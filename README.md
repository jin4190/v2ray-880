...
- 具体请[点击查看](https://github.com/keepsmile88/v2ray-agent/issues/32)，使用脚本前必读

# 1.七合一共存脚本+伪装博客
- 如果没有使用过Cloudflare[点击这里](https://github.com/keepsmile88/v2ray-agent/blob/master/documents/cloudflare_init.md)查看入门教程
...
## 安装脚本
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/KeepSmile88/v2ray-agent/master/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```

- 示例图
- 支持快捷方式启动，安装完毕后，shell输入[**vasma**]即可打开脚本，脚本执行路径[/etc/v2ray-agent/install.sh]
<img src="https://raw.githubusercontent.com/KeepSmile88/v2ray-agent/master/fodder/install/install.jpg" width=700>
